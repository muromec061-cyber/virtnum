...
📞 Поддержка: +79633051811`;
    await ctx.replyWithHTML('📤 <b>Поделись ботом с друзьями!</b>\n\nНажми кнопку ниже, чтобы переслать:', telegraf_1.Markup.inlineKeyboard([
        [telegraf_1.Markup.button.switchToChat('📤 Поделиться в чат', shareText)],
        [telegraf_1.Markup.button.url('🔗 Открыть бота', 'https://t.me/Base447bot?start=promo')],
        [telegraf_1.Markup.button.callback('⬅️ Меню', 'back_start')],
    ]));
});
// ─── /promo — promo info ───
bot.command('promo', async (ctx) => {
    await ctx.replyWithHTML('🚀 <b>Промо-акция!</b>\n\n' +
        'Пригласи 3 друзей — получи 7 дней Premium бесплатно!\n\n' +
        'Поделись ссылкой:\n<code>https://t.me/Base447bot?start=promo</code>\n\n' +
        '📞 Поддержка: +79633051811', telegraf_1.Markup.inlineKeyboard([
        [telegraf_1.Markup.button.switchToChat('📤 Поделиться', '🤖 Aisunio — 24 AI модели в Telegram! Бесплатно: https://t.me/Base447bot?start=promo')],
        [telegraf_1.Markup.button.callback('⬅️ Меню', 'back_start')],
    ]));
});
